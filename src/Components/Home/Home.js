        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item p-1">
                        <button type="button" class="btn btn-primary p-1" onClick={() => setImage(m1)} >Tareq</button>
                    </li>
                    <li class="nav-item p-1">
                        <button type="button" class="btn btn-success p-1" onClick={() => setImage(m2)} >Zaber</button>
                    </li>
                </ul>
                <div class="col-sm-12">
